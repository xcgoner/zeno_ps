...
size = _basics.size
worker_size = _basics.worker_size
validator_size = _basics.validator_size
...
def byteps_declare_tensor(name):
    MXNET_LIB_CTYPES.byteps_mxnet_declare_tensor(c_str(name))

def byteps_declare_and_init_tensor(name, tensor):
    c_in = tensor.handle
    MXNET_LIB_CTYPES.byteps_mxnet_declare_and_init_tensor(c_str(name), c_in)
